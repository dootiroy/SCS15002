...
delta<-rep(NA,n)
y<-rep(0,n)
c<-0.4 #change this to adjust the censoring rate.
...
write.table(x, file = "C:/Users/Reseearcher Mode/Desktop/simulationgev.txt")
#We just generated Data set and save in desktop!!!##
####################################################
###### generate random variables(simulation.r)
#data<-read.table("simulationmin.txt")
data<-read.table("C:/Users/Reseearcher Mode/Desktop/simulationgev.txt")
...
summary(fit1)
plot(fit1,xlab="Survival Time",ylab="Survival function estimate",xlim=c(0.2,0.7))
...
sy<-apply(YYY,2,mean)	
pdf("C:/Users/Reseearcher Mode/Desktop/SurvivalCurveByMean.pdf")
plot(fit1,xlab="Survival Time",ylab="Survival function estimate",ylim = c(0,1), xlim=c(0.2,0.7))
...
pdf("C:/Users/dooti/Desktop/Boxplots.pdf")
